...
export default function SearchScreen() {
  ...
  useEffect(() => {
    ...
    const season = monthNames.find(season => seasons[season as keyof typeof seasons].includes(currentMonth))
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#121212' }}>
      <View style={styles.container}>
        ...
        {season?.pages[0]?.data.length === 0 || season?.pages[0]?.data === undefined ? (
          <View>
